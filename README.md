...
git clone https://github.com/acentswap/bridge.git
cd bridge
make all
```
...
see more, please refer [config file example](https://github.com/acentswap/bridge/blob/master/params/config-example.toml)
...
see more, please refer [token pair config file example](https://github.com/acentswap/bridge/blob/master/params/config-tokenpair-example.toml)
...
For the config file, please refer [config file example](https://github.com/acentswap/bridge/blob/master/params/config-example.toml)
...
5. config `[APIServer]` section
    ...
    Please see more here about [bridge-API](https://github.com/acentswap/bridge/wiki/bridge-API)
